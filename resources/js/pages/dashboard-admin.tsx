        ...
        <>
            <div className="min-h-screen bg-slate-100 p-6">
                <div className="flex justify-between">
                    ...
                    <div className="">
                        <h2 className="text-center text-3xl font-semibold">Penilaian Lomba</h2>
                ...
                <div className="flex justify-end">
                    <button
                        className="my-4 rounded border-2 border-white bg-red-500 px-4 py-2 font-bold text-white hover:bg-red-600"
                ...
                <form onSubmit={handleSubmit} className="mb-6">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="lomba" className="block text-sm font-medium">
                                Pilih Jenis Lomba
                            </label>
                            <select
                                id="race_id"
                                ...
                                className="mt-1 block w-full rounded-md border-2 border-zinc-200 p-4 py-2 shadow-sm"
                            >
                        ...
                        <div>
                            <label htmlFor="pasukan" className="block text-sm font-medium">
                                No Pasukan
                            </label>
                            <select
                                id="member_id"
                                ...
                                className="mt-1 block w-full rounded-md border-2 border-zinc-200 px-4 py-2 shadow-sm"
                            >
                    ...
                    <div className="mt-4">
                        <label htmlFor="waktuLomba" className="block text-sm font-medium">
                    ...
                    <button
                        type="submit"
                        disabled={processing}
                        className="mt-6 w-full rounded-md border-2 border-zinc-200 bg-blue-600 py-2 text-2xl font-bold text-white hover:bg-blue-700 disabled:opacity-50"
                    >
                ...
                {/* Tabel Data Input */}
                <div className="mt-6 overflow-x-auto rounded-md border-2 border-zinc-200 shadow-md">
